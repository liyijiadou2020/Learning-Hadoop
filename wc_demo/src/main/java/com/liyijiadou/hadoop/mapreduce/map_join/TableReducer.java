...
// * @description: ***********************************************************
// */
//public class TableReducer extends Reducer<Text, MapJoinBean, MapJoinBean, NullWritable> {
//
//    /**
...
//     */
//    @Override
//    protected void reduce(Text key, Iterable<MapJoinBean> values, Reducer<Text, MapJoinBean, MapJoinBean, NullWritable>.Context context)
//            throws IOException, InterruptedException {
//
//        ArrayList<MapJoinBean> orderBeans = new ArrayList<>();
//        MapJoinBean pdBean = new MapJoinBean();
//
//        for (MapJoinBean tableBean : values) {
//            if ("order".equals(tableBean.getFlag())) { // 订单表
//                MapJoinBean tmpOrderBean = new MapJoinBean(); // 创建一个临时 MapJoinBean 来接收 value
//
//                try {
...
//        for (MapJoinBean orderBean : orderBeans) {
